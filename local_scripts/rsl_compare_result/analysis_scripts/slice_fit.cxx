...
void slice_fitTMP(const std::string& rsl){
    ...
    string output_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/rsl_compare_result/results/combined_3k/fitted_results/cathode/";
    ...
    for(int i=0; i<num; ++i){
        ...
        else if(rsl == "corsika_rsl50_abs20" && distances[i] == 145){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl50_abs20" && distances[i] == 155){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 5.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "corsika_rsl70_abs20" && distances[i] == 65){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 12.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl70_abs20" && distances[i] == 145){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl130_abs20" && distances[i] == 115){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 7.5;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl130_abs20" && distances[i] == 145){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl130_abs20" && distances[i] == 155){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 5.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl130_abs20" && distances[i] == 235){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl150_abs20" && distances[i] == 145){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl150_abs20" && distances[i] == 155){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 5.2;
            varsTMP.mpvIni = 0.3;
            varsTMP.sigmaIni = 0.3;
            varsTMP.widthIni = 0.4;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl150_abs20" && distances[i] == 175){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 4.5;
            varsTMP.mpvIni = 0.1;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl150_abs20" && distances[i] == 195){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.1;
            varsTMP.mpvIni = 5.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl150_abs20" && distances[i] == 225){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.1;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl150_abs20" && distances[i] == 245){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.3;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 

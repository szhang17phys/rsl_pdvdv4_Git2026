...
void slice_fitTMP(const std::string& rsl){
    ...
    string file_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/gen_compare_result/results/tmp/";
    string file_suffix = "Combine_base_" + rsl + ".root";
    string output_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/gen_compare_result/results/cathode/";
    string output_name = "fitCLG1";

    //store fitting results at txt file---
    std::ofstream outputTxt("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/gen_compare_result/results/cathode/"+rsl+"_fitCLG1.txt");

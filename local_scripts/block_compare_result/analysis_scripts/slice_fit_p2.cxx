...
void slice_fitTMP(const std::string& rsl){
    ...
    string output_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/combined_3k/fitted_results/p2/";
...
//    TH2F* inputTH2F = (TH2F*)inputFile->Get("pmt2");//Only for RSL100---    
    ...
    for(int i=0; i<num; ++i){
        ...
        else if(rsl == "corsika_rsl50_abs10" && distances[i] == 430){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 50.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "corsika_rsl50_abs10" && distances[i] == 470){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 12.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "corsika_rsl50_abs15" && distances[i] == 490){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 18.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 250){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 180.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 470){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 17.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "corsika_rsl70_abs15" && distances[i] == 230){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 280;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "corsika_rsl70_abs15" && distances[i] == 390){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 60.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "corsika_rsl70_abs15" && distances[i] == 510){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 13.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 

...
int hist_combine(){
    ...
    string rslxx ="corsika_rsl70_abs15";

    //Open the first ROOT file---
    TFile *file0 = new TFile("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/tmp/Combine_"+TString(rslxx)+"_hist.root", "READ");
    if (!file0 || file0->IsZombie()) {
        std::cerr << "Error: Unable to open file1.root" << std::endl;
        return 1;
    }
    //Open the second & third root file---
    TFile *file1 = new TFile("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/tmp/Combine_"+TString(rslxx)+"_2_hist.root", "READ");
    TFile *file2 = new TFile("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/tmp/Combine_"+TString(rslxx)+"_3_hist.root", "READ");

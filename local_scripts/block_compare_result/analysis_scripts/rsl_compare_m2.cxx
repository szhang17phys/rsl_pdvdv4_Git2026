...
void rsl_compareTMP(const std::string& path){
    ...
    std::string inputFile50 = path + "/corsika_rsl50_abs10_fitCLG1.txt";
    std::string inputFile70 = path + "/corsika_rsl50_abs15_fitCLG1.txt";
    std::string inputFile130 = path + "/corsika_rsl70_abs10_fitCLG1.txt";
    std::string inputFile150 = path + "/corsika_rsl70_abs15_fitCLG1.txt";
    ...
    //Drawing 1-------------------------------------------------------------------
    TCanvas canvas("fitCompare", "Different RSL_ABSs", 800, 600);
...
//    TGraph* scatterGraph150 = new TGraph(num, dis150, mpv150);
    ...
    legend->AddEntry(scatterGraph150, "RSL70_Abs15", "pe");
    legend->AddEntry(scatterGraph130, "RSL70_Abs10", "pe");
    legend->AddEntry(scatterGraph, "RSL100_Abs20", "pe");
    legend->AddEntry(scatterGraph70, "RSL50_Abs15", "pe");
    legend->AddEntry(scatterGraph50, "RSL50_Abs10", "pe");
    legend->Draw();
...
//    graphDiff50->GetYaxis()->SetRangeUser(-10000, 40000);
    ...
    legend2->AddEntry(graphDiff50, "RSL50_Abs10 - RSL100_Abs20", "pe");
    legend2->AddEntry(graphDiff70, "RSL50_Abs15 - RSL100_Abs20", "pe");
    legend2->AddEntry(graphDiff130, "RSL70_Abs10 - RSL100_Abs20", "pe");
    legend2->AddEntry(graphDiff150, "RSL70_Abs15 - RSL100_Abs20", "pe");
    legend2->Draw();
...
//Drawing 3-------------------------------------------------------------------
    ...
    //bias50----------
    TCanvas canvas3_rsl50("fitBias_RSL50_Abs10", "fit Bias", 800, 600);
...
//    graphBias50->GetXaxis()->SetRangeUser(0, 300);
    ...
    legend3_rsl50->AddEntry(graphBias50, "RSL50_Abs10", "pe");
    legend3_rsl50->Draw();


    //bias70----------
    TCanvas canvas3_rsl70("fitBias_RSL50_Abs15", "fit Bias", 800, 600);
...
//    graphBias70->Draw("P SAME");
    ...
    legend3_rsl70->AddEntry(graphBias70, "RSL50_Abs15", "pe");
    legend3_rsl70->Draw();


    //bias130----------
    TCanvas canvas3_rsl130("fitBias_RSL70_Abs10", "fit Bias", 800, 600);
...
//    graphBias130->Draw("P SAME");
    ...
    legend3_rsl130->AddEntry(graphBias130, "RSL70_Abs10", "pe");
    legend3_rsl130->Draw();


    //diff150
    TCanvas canvas3_rsl150("fitBias_RSL70_Abs15", "fit Bias", 800, 600);
...
//    graphBias150->Draw("P SAME");
    ...
    legend3_rsl150->AddEntry(graphBias150, "RSL70_Abs15", "pe");
    legend3_rsl150->Draw();
    ...
    legend3_All->AddEntry(graphBias50, "RSL50_Abs10", "pe");
    legend3_All->AddEntry(graphBias70, "RSL50_Abs15", "pe");
    legend3_All->AddEntry(graphBias130, "RSL70_Abs10", "pe");
    legend3_All->AddEntry(graphBias150, "RSL70_Abs15", "pe");
    legend3_All->Draw();
...
//    rsl_compareTMP("../results/fit_Develop/membrane1");
    ...
    //For membrane2---
    rsl_compareTMP("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/combined_3k/fitted_results/m2");

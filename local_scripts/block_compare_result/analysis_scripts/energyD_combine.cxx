...
int energyD_combine(){
    ...
    TFile *file0 = new TFile("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/tmp/opCh00_corsika_rsl70_abs15_hist.root", "READ");
    if (!file0 || file0->IsZombie()) {
        std::cerr << "Error: Unable to open file1.root" << std::endl;
        return 1;
    }
    //Open the second root file---
    TFile *file1 = new TFile("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/tmp/opCh00_corsika_rsl70_abs15_2_hist.root", "READ");
    //Open the third root file---
    TFile *file2 = new TFile("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/tmp/opCh00_corsika_rsl70_abs15_3_hist.root", "READ");

    //Output location:------------
    string output_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/combined_3k/";
    string output_name = "rsl70_abs15_energyDistribution.root";
    //===================================================

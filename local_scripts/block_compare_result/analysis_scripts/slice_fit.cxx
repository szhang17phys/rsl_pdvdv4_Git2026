...
void slice_fitTMP(const std::string& rsl){
    ...
    string file_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/combined_3k/";
    string file_suffix = rsl + "_3000num_crtCut.root";
    string output_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/new_20250127/block_compare_result/results/combined_3k/fitted_results/cathode/";
    ...
    for(int i=0; i<num; ++i){
        ...
        if(rsl == "corsika_rsl100_abs20" && distances[i] == 65){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 12.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "corsika_rsl100_abs20" && distances[i] == 135){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0;
            varsTMP.mpvIni = 6.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "corsika_rsl100_abs20" && distances[i] == 145){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl100_abs20" && distances[i] == 155){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 5.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }   
        else if(rsl == "corsika_rsl100_abs20" && distances[i] == 195){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl100_abs20" && distances[i] == 225){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl50_abs10" && distances[i] == 125){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl50_abs10" && distances[i] == 175){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl50_abs10" && distances[i] == 185){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl50_abs10" && distances[i] == 195){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl50_abs10" && distances[i] == 205){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl50_abs10" && distances[i] == 215){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl50_abs15" && distances[i] == 115){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 7.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl50_abs15" && distances[i] == 135){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl50_abs15" && distances[i] == 195){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 3.5;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl50_abs15" && distances[i] == 205){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 105){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 7.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 115){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 7.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 125){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 145){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 185){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 3.5;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 195){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 215){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
        ...
        else if(rsl == "corsika_rsl70_abs10" && distances[i] == 225){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 2.5;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "corsika_rsl70_abs15" && distances[i] == 85){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 10.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "corsika_rsl70_abs15" && distances[i] == 155){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
...
//    slice_fitTMP("corsika_rsl50_abs10");
//    slice_fitTMP("corsika_rsl50_abs15");
//    slice_fitTMP("corsika_rsl70_abs10");      
    slice_fitTMP("corsika_rsl70_abs15");    
